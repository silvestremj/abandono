...
class GestorBaseDatos:
    ...
    def __init__(self, db_name="estudiantes.db"):
        self.db_path = os.path.join(os.path.dirname(__file__), "..", db_name)

    def inicializar_tablas_fijas(self):
    ...
    def guardar_datos_raw(self, datasets_dict):
